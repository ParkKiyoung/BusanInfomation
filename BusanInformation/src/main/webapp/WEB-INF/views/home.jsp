...
<script>
$(document).ready(function(){//뉴스 검색 결과 가져옴(구글)
	$.get("/GetMainNews",function(data){
		...
		for(var i = 0 ; i<data.length;i++){
			...
			newsBoard+="<a href="+data[i].link+">"+(i+1)+". "
	...
	$.get("/GetWeather",function(data){//날씨정보 가져옴(네이버)
		data = $.parseJSON(data);
		var weather = "";
		weather+="<table>"
		weather+="<tr><td>오늘 날짜 </td><td width=200px height=25px align=center> "+data.todayDate+"</td>"
		weather+="<tr><td>현재시각 </td><td width=200px  height=25px align=center>"+data.nowTime+"시 기준</td>"
		weather+="<tr><td>기온 </td><td width=200px  height=25px align=center>"+data.nowTemp+"℃</td>"
		weather+="<tr><td>날씨 </td><td width=200px  height=25px align=center> "+data.nowWeather+"</td>"
		weather+="<tr><td>미세먼지 </td><td width=200px  height=25px align=center> "+data.dust+"</td>"
		weather+="<tr><td>오존 </td><td width=200px  height=25px align=center> "+data.ozon+"</td>"
		
		weather+="<tr><td>오전 기온 </td><td width=200px height=25px  align=center> "+data.todayAMTemp+"</td>"
		weather+="<tr><td>오후 기온 </td><td width=200px height=25px  align=center> "+data.todayPMTemp+"</td>"
		weather+="</table>"
			...
			<!-- Banner -->
				<div id="banner-wrapper">
					<div class="container">
						...
						<div id="banner">
					<h2>Most ImportantThings..<br>When you tour BUSAN</h2>
						</div>
						...
						<div class="row main-row">
							...
							<div class="col-6 col-12-medium">
								...
								<article class="blog-post">
									<h2>부산 여행 사진</h2>
									<img src = "" width=450px height=500px>			
								</article>
