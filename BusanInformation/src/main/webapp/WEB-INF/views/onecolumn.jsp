					...
					<div class="container">
						<div class="row">
							<div class="col-12">
								...
								<header id="header">
									<h1><a href="home" id="logo">부산여행정보</a></h1>
									<nav id="nav">
										<a href="index.html">부산에 관하여</a>
										<a href="twocolumn1.html">관광 정보</a>
										<a href="twocolumn2.html">대중 교통</a>
										<a href="/onecolumn.html" class="current-page-item">숙박업소</a>
										<a href="threecolumn.html">게시판</a>
									</nav>
								</header>
